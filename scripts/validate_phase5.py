...
def main() -> None:
    ...
    for statement in (
        ...
        "14 tests with zero failures",
        "ten tests with zero failures",
        "two tests with zero failures",
        "no node 20 deprecation annotation",
        "testpulse run 183",
        "performance gates as 187",
        "only failing job was browser quality",
    ...
    for contract in (
        "enable_allure_pages=true",
        "five eligible release-run inputs",
